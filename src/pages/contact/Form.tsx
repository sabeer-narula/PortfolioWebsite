...
function Form({ isDarkMode, isMobile }: FormProp) {
  ...
  const handleValidation = () => {
    ...
    if (touched["from_name"] && !formFields["from_name"]) {
      formIsValid = false;
    ...
    } else if (touched["from_name"] && !formFields["from_name"].match(/^[a-z ,.'-]+$/i)) {
      formIsValid = false;
      formErrors["from_name"] = {
    ...
    if (touched["from_email"] && !formFields["from_email"]) {
      formIsValid = false;
      ...
      touched["from_email"] &&
      formFields["from_email"] &&
      !formFields["from_email"].match(
    ...
    if (touched["message"] && !formFields["message"]) {
      formIsValid = false;
      formErrors["message"] = {
        icon: <IconAlertCircleFilled className="h-4 w-4 text-red-200" />,
        text: "Required",
